...
all: CXXFLAGS= -DNDEBUG -O3 -pthread -std=c++23  -Iinclude -MMD 
...
build/src/io/json/Path.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++23 -Iinclude -Isrc -I./cpp_modules/fmt/dist/include -MMD
